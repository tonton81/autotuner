    ...
    with open(os.path.join(sys.path[0], "user.bin"), "rb+") as f:
        ...
        if input_bin_hash == '0c21cdf567d6a5a5faaf4512af1029f0': #CR-V thanks to martin146, cfranhonda
            ...
            data_new = [
                ...
                '0x0000, 0x0468, 0x08D0, 0x0D38, 0x11A0, 0x1608, 0x2808, 0x3A08, 0x4C08', # new torque_table row 1
                '0x0000, 0x0917, 0x0DC5, 0x1017, 0x119F, 0x1E1B, 0x3600, 0x4E00, 0x5A00', # new torque_table row 2
                '0x0000, 0x0917, 0x0DC5, 0x1017, 0x119F, 0x1E1B, 0x3600, 0x4E00, 0x5A00', # new torque_table row 3
                '0x0000, 0x0917, 0x0DC5, 0x1017, 0x119F, 0x1E1B, 0x3600, 0x4E00, 0x5A00', # new torque_table row 4
                '0x0000, 0x0917, 0x0DC5, 0x1017, 0x119F, 0x1E1B, 0x3600, 0x4E00, 0x5A00', # new torque_table row 5
                '0x0000, 0x0917, 0x0DC5, 0x1017, 0x119F, 0x1E1B, 0x3600, 0x4E00, 0x5A00', # new torque_table row 6
                '0x0000, 0x06B3, 0x0B1A, 0x0CCD, 0x0E9A, 0x18F3, 0x2BEA, 0x3D05, 0x4768', # new torque_table row 7
